<?php
	...
	$rows = $mysqli->query("SELECT
							...
							WHERE
								...
								messages.toDeleted = 0
								AND messages.toArchived = 1");
    ...
    $arc = "SELECT
			...
			WHERE
				...
				messages.toArchived = 1
			ORDER BY
				messages.messageId DESC ".$pages->get_limit();
    $arcres = mysqli_query($mysqli, $arc) or die('-1' . mysqli_error());
...
<div class="wrapper">
	...
	<ul class="nav nav-tabs tzTabs">
		...
		<li class="active"><a href="#archived" data-toggle="tab"><i class="icon-archive"></i> <?php echo $archivedTabLink; ?></a></li>
	</ul>

	<div class="tab-content">
		<div class="tab-pane active" id="archived">
			<?php if(mysqli_num_rows($arcres) < 1) { ?>
				<div class="alertMsg default">
					<i class="icon-minus-sign"></i> <?php echo $noArchivedMsg; ?>
				</div>
			<?php } else { ?>
				<table id="responsiveTable" class="large-only" cellspacing="0">
					...
					<?php
					while ($row = mysqli_fetch_assoc($arcres)) {
					...
					?>
								...
								<div class="modal-content">
									...
									<div class="modal-footer">
										<form action="" method="post">
											...
											<a data-toggle="modal" href="#deleteArchived<?php echo $row['messageId']; ?>" class="btn btn-danger btn-icon floatLeft" data-dismiss="modal"><i class="icon-trash"></i> <?php echo $deleteBtn; ?></a>
											...
											<button type="input" name="submit" value="moveInbox" class="btn btn-success btn-icon"><i class="icon-inbox"></i> <?php echo $moveToInboxBtn; ?></button>
						...
						<div class="modal fade" id="deleteArchived<?php echo $row['messageId']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
							<div class="modal-dialog">
								<div class="modal-content">
									<form action="" method="post">
										<div class="modal-body">
											<p class="lead"><?php echo $deleteArchivedConf; ?></p>
										</div>
										<div class="modal-footer">
				...
				<div class="modal-body">
					<div class="form-group">
						<?php
							...
							$empres = mysqli_query($mysqli, $getEmps) or die('-7' . mysqli_error());
						?>
